                ...
                <form action="{{ route('checkViOnline') }}" class="formthanhtoan" method="post">
                    ...
                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($doAn as $item)
                                                <tr>
                                                    ...
                                                    @php
                                                        $id = $item->id;
                                                        $locId = array_filter($dataSoluongDoAn, function ($value) use (
                                                            $id,
                                                        ) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <div class="tonggiave">{{ number_format($tong, 0, ',', '.') }}</div>
                                                    &nbsp;₫
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            @foreach ($magiamgia as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ date('d/m/Y', strtotime($item->ngay_bat_dau)) . ' - ' . date('d/m/Y', strtotime($item->ngay_ket_thuc)) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <div class="ms-4 mr-4 mb-5">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ Auth::user()->ho_ten }}" id="exampleInputEmail1"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ Auth::user()->so_dien_thoai }}" id="exampleInputEmail1"
                                                disabled>
                        ...
                        <div class="col-lg-4 col-12 order-sm-last">
                                ...
                                <div class="table-responsive table-food">
                                    ...
                                    <div class="ms-4 mr-4 mb-3 thanhtoanquavi activeThanhToan" style="cursor: pointer;">
                                        <div class="d-flex mt-2 ms-3 mb-2 mr-2 align-items-center"
                                            ...
                                            <input type="radio" class="viOline" style="display: none;" name="viOline"
                                                value="momo" checked>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                class="mr-2 icon-check" height="20" style="color: #f05050;"
                                    ...
                                    <div class="ms-4 mr-4 mb-3 thanhtoanquavi" style="cursor: pointer;">
                                        <div class="d-flex mt-2 ms-3 mb-2 mr-2 align-items-center"
                                            ...
                                            <img width="30px"
                                                ...
                                                alt="">
                                            <p class="ms-3" style="font-size: 14px;font-weight:500;">ZaloPay(Thẻ tín
                                                dụng)</p>
                                        </div>
                                    </div>
                                    <div class="ms-4 mr-4 mb-3 thanhtoanquavi" style="cursor: pointer;">
                                        <div class="d-flex mt-2 ms-3 mb-2 mr-2 align-items-center"
                                            ...
                                            <img width="30px" style="border-radius: 4px;"
                                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSfoJMilWmJVz7FRP88J1cQ_Vhkdpqr0HVjQ&s"
                                                alt="">
                                            <p class="ms-3" style="font-size: 14px;font-weight:500;">Thanh toán qua xu
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="container-ticket-information">
                                <div class="content-ticket-information d-flex justify-content-between"
                                    style="width:100%;">
                                    <div>
                                        <p style="color:#95aac9;">Tổng đơn hàng</p>
                                        <strong style="font-size:19px;font-weight:500;"><span
                                                class="tonggiave">{{ number_format($tong, 0, ',', '.') }}</span>&nbsp;₫</strong
                                    ...
                                    <div class="justify-content-end d-flex flex-column" style="text-align: end;">
                                        ...
                                        <strong class="text-danger demthoigian"
                                            style="font-size:19px;font-weight:500;">05:00</strong>
                                    </div>
                                </div>
                                <div class="mb-3 mt-2 ps-2 pr-2 d-flex">
                                    ...
                                    <button type="button"
                                        class="ms-2 btn-magiamgia action-next btn btn-dark d-flex justify-content-center"
                            ...
                            <div class="container-total-oldel-ticket">
                                <div class="content-total-oldel-ticket">
                                    <p>
                                        ...
                                        Mã vé sẽ được gửi
                                        <strong>01</strong>
                                        lần qua email đã đăng ký tài khoản. Vui lòng kiểm tra lại thông tin trước khi tiếp
                                        tục.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="flow-actions sticky-footer-bars">
                                    <div class="row">
                                        <div class="col-12"><button type="submit"
                                                class="btn-submitthanhtoan action-next btn btn-lg btn-dark btn-block"><span
