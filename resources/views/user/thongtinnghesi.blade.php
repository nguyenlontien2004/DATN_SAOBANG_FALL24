            ...
            <div class="col-sm-2">
                <div>
                    <img class="imgae-nghe-si"
                        src="{{ isset($dienvien->anh_dien_vien) ? asset('storage/' . $dienvien->anh_dien_vien) : 'https://cdn.moveek.com/bundles/ornweb/img/no-poster.png' }}"
                        alt="">
                </div>
            </div>
            <div class="col-sm-10">
                <div class="mb-3">
                    <h2 style="font-size: 1.625rem;font-weight: 500;">{{ $dienvien->ten_dien_vien }}</h2>
                </div>
                <div class="mb-2">
                    <p>{!! $dienvien->tieu_su !!}</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container mb-4" style="max-width: 80rem;margin: 0 auto;margin-top:2.239rem;">
    <div class="d-flex align-items-center" style="justify-content: center;">
        @foreach ($dienvien->phims as $item) 
