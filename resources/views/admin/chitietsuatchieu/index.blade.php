                                    ...
                                    @foreach ($value as $item)
                                        <div class="col-md-6 mt-2">
                                            <div class="seat-selection"
                                                ...
                                                <p class="ps-2">
                                                    Phòng:&nbsp{{ $item->phongChieu->ten_phong_chieu }}&nbsp-&nbsp Tại
                                                    rạp:&nbsp{{ $item->phongChieu->rap->ten_rap }}
                                                </p>
                                                <p class="ps-2">
                                                    @php
                                                        $count = 0;
                                                        $countsuatchieu = Ve::withCount('chiTietVe')
                                                            ->where('suat_chieu_id', $item->id)
                                                            ->get()
                                                            ->pluck('chi_tiet_ve_count');
                                                        for ($i = 0; $i < count($countsuatchieu); $i++) {
                                                            $count += $countsuatchieu[$i];
                                                        }
                                                    @endphp
                                                    Số ghế bán ra:&nbsp{{ $count }}
                                                </p>
                                                <div class="legend">
                                                    <div>
                                                ...
                                                <div class="seats-wrapper-parent" style="padding: 0px 10px 10px 10px;">
                                                    <div class="seats-wrapper-row">
                                                        ...
                                                        <div class="seats-map">
                                                            ...
                                                            @php foreach($value[$i]['chitietve'] as $check){
