                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <form action="{{ route('admin.doans.store') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <img id="hinh_anh_dm" src="" alt="Ảnh đồ ăn" style="width: 150px; display: none">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="mo_ta" id="mo_ta" class="form-control @error('mo_ta') is-invalid @enderror" placeholder="Nhập mô tả">{{ old('mo_ta') }}</textarea>
                                                    @error('mo_ta')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="luot_mua" id="luot_mua" class="form-control @error('luot_mua') is-invalid @enderror" value="{{ old('luot_mua') }}" placeholder="Nhập lượt mua">
                                                    @error('luot_mua')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
