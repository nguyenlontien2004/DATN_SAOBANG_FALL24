                        ...
                        <form action="{{ route('admin.roleAndUser.update', $roleAndUser->nguoi_dung_id) }}" method="post">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Sửa vai trò cho tài khoản <strong>{{ $roleAndUser->user->email }}</strong></div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ $roleAndUser->user->ho_ten }}" id="disableinput"
                                                    placeholder="Enter Input" disabled="">
                                            </div>
                                            <div class="form-group">
                                                <label for="disableinput">Email tài khoản</label>
                                                <input type="text" class="form-control" value="{{ $roleAndUser->user->email }}" id="disableinput"
                                                    placeholder="Enter Input" disabled="">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="vai_tro_id" id="exampleFormControlSelect1">
                                                    ...
                                                    @if ($item->id == $roleAndUser->vai_tro_id)
                                                    selected
                                                    @endif
