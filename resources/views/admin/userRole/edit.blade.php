        ...
        <div class="main-panel">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.roleAndUser.update', $roleAndUser->nguoi_dung_id) }}"
                                method="post">
                                @csrf
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Sửa vai trò cho tài khoản
                                            <strong>{{ $roleAndUser->user->email }}</strong></div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $roleAndUser->user->ho_ten }}" id="disableinput"
                                                        placeholder="Enter Input" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="disableinput">Email tài khoản</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ $roleAndUser->user->email }}" id="disableinput"
                                                        placeholder="Enter Input" disabled="">
                                                </div>
                                                <div class="form-group">
