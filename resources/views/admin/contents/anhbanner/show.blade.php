            ...
            <div class="card-body">
                <form action="{{ route('bai-viet-tin-tuc.update', $baiVietTinTuc->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="noi_dung" class="form-control" id="noi_dung" rows="5" value="{{ $baiVietTinTuc->noi_dung }}"
                            required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="tom_tat">Tóm tắt</label>
                        <textarea name="tom_tat" class="form-control" id="tom_tat" value="{{ $baiVietTinTuc->tom_tat }}" rows="3"
                            required></textarea>
                    </div>
