                        ...
                        @foreach ($phims as $index => $phim)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('phim.forceDelete', $phim->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa vĩnh viễn mục này không?');">
                                        @csrf
                                        @method('DELETE')
