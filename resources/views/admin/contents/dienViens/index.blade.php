...
<div class="card container mt-5">
    <div class="card-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('dienVien.create') }}" class="">Thêm mới Diễn Viên</a>
            <span class="px-2">/</span>
            <a href="{{ route('dienVien.listSoftDelete') }}">Các mục đã xoá mềm</a>
        </div>
    </div>
    <div class="card-body">
        <table class="table ">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                <form method="POST" action="{{ route('dienVien.softDelete', $dienVien->id) }}"
