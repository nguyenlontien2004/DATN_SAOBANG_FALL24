        ...
        <div class="card-body">
            <form action="{{ route('rap.update', $rap->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="ten_rap" name="ten_rap" value="{{ old('ten_rap', $rap->ten_rap) }}" required>
                </div>

                <div class="mb-3">
                    <label for="dia_diem" class="form-label">Địa Điểm</label>
                    <input type="text" class="form-control" id="dia_diem" name="dia_diem" value="{{ old('dia_diem', $rap->dia_diem) }}" required>
                </div>
