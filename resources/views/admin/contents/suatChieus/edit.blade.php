        ...
        <div class="card-body">
            ...
            <form action="{{ route('suatChieu.update', $suatChieu->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="gio_bat_dau" name="gio_bat_dau" value="{{ $suatChieu->gio_bat_dau }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="trang_thai" name="trang_thai" required>
                        ...
                        <option value="0" {{ old('trang_thai', $suatChieu->trang_thai) == 0 ? 'selected' : '' }}>Không hoạt động</option>
                    </select>
                </div>
