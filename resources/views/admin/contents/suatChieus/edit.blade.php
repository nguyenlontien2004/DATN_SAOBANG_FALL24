    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('suatChieu.update', $suatChieu->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <select class="form-select" id="phong_chieu_id" name="phong_chieu_id">
                            @foreach ($phongChieus as $phongChieu)
                                <option value="{{ $phongChieu->id }}" 
                                    {{ old('phong_chieu_id', $suatChieu->phong_chieu_id) == $phongChieu->id ? 'selected' : '' }}>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6">
                        <label for="date" class="form-label">Ngày chiếu phim</label>
                ...
                @error('phim_id')
                <div class="text-danger m-3 text-center">{{ $message }}</div>
            @enderror
