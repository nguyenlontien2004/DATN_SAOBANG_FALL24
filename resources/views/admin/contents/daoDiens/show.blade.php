    ...
    <div class="card container mt-5">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex justify-content-center">
                <form method="POST" action="{{ route('daoDien.destroy', $daoDiens->id) }}"
                ...
                <a class="btn btn-warning" href="{{ route('daoDien.edit', $daoDiens->id) }}">
                    Sửa
                </a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <img alt="Movie poster" class="img-fluid shadow rounded" style="height: 450px; object-fit: cover;"
                        src="{{ asset('storage/' . $daoDiens->anh_dao_dien) }}" />
                </div>
                <div class="col-md-8">
                    <h2 class="movie-title">{{ $daoDiens->ten_dao_dien }}</h2>
                    <div class="movie-info">
                        <div class="d-flex mb-2">
                            <div class="mr-5">
                                <strong>Ngày Sinh</strong>
                                <p>{{ $daoDiens->nam_sinh }}</p>
                            </div>
                        </div>
                        <div class="mb-2">
                            <strong>Quốc gia</strong>
                            <p>{{ $daoDiens->quoc_tich }}</p>
                        </div>
                        <div class="mb-2">
                            <strong>Giới Tính</strong>
                            <p>{{ $daoDiens->gioi_tinh }}</p>
                        </div>
                        <div class="mb-3">
                            <span class="badge text-dark fs-4 p-2">
                                @if ($daoDiens->trang_thai == 1)
