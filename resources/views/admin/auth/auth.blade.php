    ...
    <div class="container container-login animated fadeIn"
      ...
      <div class="login-form">
        <form action="{{ route('login') }}" method="post">
          ...
          <div class="form-sub">
            <div class="mb-3">
              <input name="email" value="{{ old('email') }}" type="text" class="inputAuth" placeholder="Email" required>
              @error('email')
          <small id="emailHelp2" class="form-text text-muted text-danger pt-1">{{ $message  }}</small>
        @enderror
            </div>
            <div class="mb-3" style="position:relative;">
              <input id="password" name="mat_khau" value="{{ old('mat_khau') }}" type="password"
                class="inputAuth inputPasLogin" placeholder="Password" style="padding-right: 40px;" required>
        ...
        @enderror
          ...
          <small id="emailHelp2" class="form-text text-muted text-danger">{{ session()->get('error') }}</small>
        @endif
            </div>
          </div>
