                        ...
                        <div class="modal-content">
                                    ...
                                    <div class="row create-seats-row" id="0">
                                        <div class="col-md-12 px-3">
                                            <div class="input-group input-group-static" style="padding: 0 12px;">
                                                ...
                                                <select id="0"
                                                    class="js-example-basic-seats-0 select-seat form-control"
                                        ...
                                        <div class="col-md-12 d-flex">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select typeSeat typeSeat-0" name="typeSeat-0"
                                                    id="0">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="position-relative">
                                    <button type="submit" id="btn-submitCreateSeats"
                                    ...
                                    <div class="container-ticket-information bg-white">
                                        <div class="content-ticket-information d-flex w-full flex-wrap ">
                                            ...
                                            <div class="ms-2 mt-1 btn-group">
                                                ...
                                                <ul class="dropdown-menu" id="editTypeSeat"
                                                    aria-labelledby="btnGroupDrop1">
                                                    <li data-type="thuong"><a class="dropdown-item"
                                                            style="cursor:pointer">Ghế Thường</a></li>
                                                    <li data-type="vip"><a class="dropdown-item"
                                                            style="cursor:pointer">Ghế
                                                            Vip</a></li>
                                                    <li data-type="doi"><a class="dropdown-item"
                                                            style="cursor:pointer">Ghế
                                                            Đôi</a></li>
                                                </ul>
                                            </div>
