                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex">
                                                           ...
                                                           <strong style="font-size: 14.5px;">{{ $item->showtime->movie->ten_phim }}</strong>
                                                           <p style="font-size: 12.5px;">2024 · {{ $item->showtime->movie->thoi_luong }} phút</p>
                                                           </div>
                                                        </div>
                                                    </td>
                                                    <td>{{ $item->user->ho_ten }}</td>
                                                    <td>{{ $item->showtime->screeningRoom->ten_phong_chieu }}</td>
                                                    <td>{{ $item->discountCode == null ? 'Không áp dụng' : $item->discountCode->ten_ma_giam_gia }}</td>
                                                    <td>
