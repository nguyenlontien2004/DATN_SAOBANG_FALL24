                                                                    ...
                                                                    foreach ($pv->suatChieus as $sc) {
                                                                        ...
                                                                        foreach ($sc->ves as $ve) {
                                                                            foreach ($ve->detailTicket as $chitietve) {
                                                                                $soLuongGhe += 1;//$ve->detailTicket->sum('ghe_ngoi_id')
                                                                            }
                                                                            //  dd($ve->toArray());
                                                                        }
                                                                    }
...
<script>
        ...
        const labels = @json(collect($tongDoanhThuTheoPhim)->pluck('ten_phim'));
        const data = @json(collect($tongDoanhThuTheoPhim)->pluck('doanh_thu'));
