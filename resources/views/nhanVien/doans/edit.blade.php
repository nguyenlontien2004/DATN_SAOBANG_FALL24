                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <form action="{{ route('do-an.update', $doAn->id) }}" method="post"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <img id="hinh_anh_dm" src="{{ Storage::url($doAn->hinh_anh) }}"
                                                        alt="Ảnh đồ ăn" style="width: 150px;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="mo_ta" id="mo_ta" class="form-control @error('mo_ta') is-invalid @enderror"
                                                        placeholder="Nhập mô tả">{{ $doAn->mo_ta }}</textarea>
                                                    @error('mo_ta')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="luot_mua" id="luot_mua"
                                                        ...
                                                        value="{{ $doAn->luot_mua }}" placeholder="Nhập lượt mua">
                                                    @error('luot_mua')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
