    ...
    <div class="card m-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('nhanvientheLoaiPhim.create') }}">Thêm mới Thể loại phim</a>
                <span class="px-2">/</span>
                <a href="{{ route('nhanvien.theLoaiPhim.listSoftDelete') }}">Các mục đã xoá mềm</a>
            </div>
            <div>
                <form class="form-inline d-flex align-items-center" action="" method="GET">
                        ...
                        @foreach ($theLoaiPhims as $index => $theLoai)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('nhanvien.theLoaiPhim.softDelete',$theLoai->id) }}" method="POST"
                                        ...
                                        <a class="btn btn-warning btn-sm"
                                            href="{{ route('nhanvientheLoaiPhim.edit',$theLoai->id) }}">
                                            Sửa
                                        </a>
                                    </div>
                                </td>
