...
@section('content')
    <div class="page-inner">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('bai-viet-tin-tuc-nv.update', $baiVietTinTuc->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('bai-viet-tin-tuc-nv.index') }}" class="btn btn-danger">Quay lại</a>
                    </div>
                </form>
            </div>
        </div>
