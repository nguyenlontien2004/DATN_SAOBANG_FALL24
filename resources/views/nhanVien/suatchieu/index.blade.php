    ...
    <div class="card m-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('nhanvienSuatchieu.create') }}">Thêm mới suất chiếu</a>
                <span class="px-2">/</span>
                <a href="{{ route('nhanvien.suatChieu.listSoftDelete') }}">Các mục đã xoá mềm</a>
            </div>
            <div>
                <form action="{{ route('nhanvienSuatchieu.index') }}" method="GET" class="form-inline d-flex align-items-center">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('nhanvienSuatchieu.index') }}" class="mb-4">
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center align-items-center">
                                         <form action="{{ route('nhanvien.huysuatchieu', $suatChieu->id) }}" 
                                        ...
                                        <form action="{{ route('nhanvien.suatchieu.softDelete', $suatChieu->id) }}" method="POST"
                                        ...
                                        <a class="btn btn-warning btn-sm mr-1" style="margin-right: 2px;"
                                            href="{{ route('nhanvienSuatchieu.edit', $suatChieu->id) }}">Sửa</a>
                                        <a class="btn btn-info btn-sm mr-1" style="margin-right: 2px;"
                                            href="{{ route('nhanvienSuatchieu.show', $suatChieu->id) }}">Xem</a>
                                    </div>
                                </td>
                            </tr>
                        @empty
