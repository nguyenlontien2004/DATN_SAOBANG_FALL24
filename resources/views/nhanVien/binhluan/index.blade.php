        ...
        <div class="content">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Quản lí bình luận phim</h4>
                </div>
            </div>
            <div class="row mr-4">
                <div class="col-xl-12">
